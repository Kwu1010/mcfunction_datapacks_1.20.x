...
execute as @e[tag=missile,tag=ap_shell] at @s unless block ^ ^1 ^1 #202:non_solid run tag @s add impact
...
execute as @e[tag=missile,tag=he_shell] at @s unless block ^ ^1 ^1 #202:non_solid run tag @s add detonate
