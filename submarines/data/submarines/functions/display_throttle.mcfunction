...
execute as @a[tag=driver,scores={vehicle_speed=..4}] at @s run title @s actionbar ["",{"text":"Use '/trigger manual-submarine set #' to open the operator manual, where # is the page number [1-4].","color":"gold","bold":"false"}]
