...
scoreboard players set flight_threshold vehicle_speed 80
...
scoreboard players set avia change_counter 3
scoreboard players set zero change_counter 4
scoreboard players set corsair change_counter 5
scoreboard players set propeller_plane change_counter 6
scoreboard players set thirtyfive change_counter 6
scoreboard players set nonmisc change_counter 9
