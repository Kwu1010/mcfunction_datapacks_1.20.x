...
execute as @a[tag=pilot,scores={vehicle_speed=..4}] at @s run title @s actionbar ["",{"text":"Use '/trigger manual-plane set #' to open the operator manual, where # is the page number [1-3].","color":"gold","bold":"false"}]
