...
tellraw @a[scores={recipe-coilgun=1..}] [{"text":"Iron Block   ","color":"gold"},{"text":" | ","color":"gold"},{"text":"Copper Ingot","color":"gold"},{"text":" | ","color":"gold"},{"text":"","color":"gold"}]
tellraw @a[scores={recipe-coilgun=1..}] [{"text":"Copper Ingot","color":"gold"},{"text":" | ","color":"gold"},{"text":"Iron Block   ","color":"gold"},{"text":" | ","color":"gold"},{"text":"Gold Ingot   ","color":"gold"}]
tellraw @a[scores={recipe-coilgun=1..}] [{"text":"                 ","color":"gold"},{"text":" | ","color":"gold"},{"text":"Gold Ingot   ","color":"gold"},{"text":" | ","color":"gold"},{"text":"Lightning Rod","color":"gold"}]
